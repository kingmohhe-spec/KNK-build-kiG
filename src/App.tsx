...
function App() {
  ...
  const products = [
    { icon: Hammer, name: 'Building Materials', items: 'Cement, Bricks ,Timber, Roofing shets', image: 'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg?auto=compress&cs=tinysrgb&w=600' },
