...
function App() {
  ...
  const products = [
    ...
    { icon: Layers, name: 'Flooring & Finishes', items: 'Tiles,Ceramic & porcelain tiles, Vinyl & laminate flooring, Tile adhesive & grout, Skirting boards,  Paint & varnishes, Brushes, rollers & painting accessories,, Wallpaper & wall panels Paint, Varnish, Sealers', image: 'https://media.istockphoto.com/id/1297516234/photo/ceramic-tiles-installation.jpg?s=612x612&w=0&k=20&c=JP4-GFDDgSUL3na-xt-LN3iGGfYTviGZh4NEaX92vhM=' },
