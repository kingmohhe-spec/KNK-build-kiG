...
function App() {
  ...
  const products = [
    { icon: Hammer, name: 'Building Materials', items: 'Cement, Bricks ,Plumbing, Timber & Board Products, Reinforce mesh and more!', image: 'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { icon: Wrench, name: 'Tools & Equipment', items: 'Hand tools (hammers, spanners, pliers, screwdrivers), Power tools (drills, grinders, saws, sanders), Measuring tools (tape measures, spirit levels), Ladders & access equipment, Workwear & PPE (gloves, safety glasses, boots)', image: 'https://images.pexels.com/photos/279810/pexels-photo-279810.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { icon: Package, name: 'Plumbing & Essentials', items: 'Pipes & fittings (PVC, copper), Taps & mixers, Toilets, cisterns & basins, Geysers & related fittings, Drainage & guttering accessories, Sealants & plumbing tape, Water tanks & pumps', image: 'https://media.istockphoto.com/id/869658498/photo/plumbing-tools-and-accessories-on-wooden-table-top-view.jpg?s=612x612&w=0&k=20&c=ED8G5fG89rIxvaHKR8DFAKuQywWrLSIw0np-6dGmEsU=' },
    { icon: Shield, name: 'Roofing & Cladding', items: 'IBR & corrugated roof sheeting, Roof tiles, Trusses & timber roofing structures, Gutters & downpipes, Insulation (ceiling/roof), Fascia boards & cladding panels, Roof screws, bolts & flashing', image: 'https://media.istockphoto.com/id/510206115/photo/corrugated-sheets-of-metal.webp?a=1&b=1&s=612x612&w=0&k=20&c=7Tzt_pWi7pIUFhuSn0RDBIi2D_nPJ3jWVEAzf8q94Yg=' },
    { icon: Layers, name: 'Flooring & Finishes', items: 'Ceramic & porcelain tiles, Vinyl & laminate flooring, Tile adhesive & grout, Skirting boards, Paint & varnishes, Brushes, rollers & painting accessories, Wallpaper & wall panels', image: 'https://media.istockphoto.com/id/1297516234/photo/ceramic-tiles-installation.jpg?s=612x612&w=0&k=20&c=JP4-GFDDgSUL3na-xt-LN3iGGfYTviGZh4NEaX92vhM=' },
    ...
    { icon: Lock, name: 'Security', items: 'Door locks & deadbolts, Padlocks & chains, Security gates', image: 'https://images.unsplash.com/photo-1754414266760-f21ba503ce9f?q=80&w=1697&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
  
    { icon: Leaf, name: 'Garden & Decoration', items: 'Garden tools (spades, rakes, forks, hoes), Wheelbarrows & trolleys, Hoses, sprinklers & irrigation fittings, Fencing & trellis', image:'https://www.istockphoto.com/vector/vector-wheelbarrow-with-garden-accessories-gm528915710-93144885'}
  ];
      ...
      <section id="services" className="relative py-24 bg-gradient-to-br from-gray-50 via-blue-50 to-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              SERVING ALL YOUR HARDWARE NEEDS!
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              },
              {
                ...
                role: 'Business Owner',
                text: 'Great prices with bulk purchases. Professional service.',
                rating: 5
              },
              {
                name: 'John Sithole',
